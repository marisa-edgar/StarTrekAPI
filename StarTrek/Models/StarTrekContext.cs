        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<Character>()
                .HasData(
                    ...
                    new Character { Name = "Wesley Crusher", Bio = "Ensign aboard the USS Enterprise-C, training to become a Starfleet Officer." },
            ...
            builder.Entity<TrekEvent>()
                .HasData(
                    new TrekEvent { Date = 1986, Description = "The crew of the USS Enterprise return back to Earth after their voyage to save Spock, only to find that an alien life-form probing Earth. Earth is destroyed, forcing the crew to find a way to travel back in time to prevent Earth's destruction." },

                    new TrekEvent { Date = 2026, Description = "World War III starts on Earth. Eco-Terrorists attack the world. 37 Million people die." },

                    new TrekEvent { Date = 2032, Description = "The creator of the warp drive: Zefram Cochrane, is born." },

                    new TrekEvent { Date = 2053, Description = "World War III comes to an end. The world is in shambles after a long nuclear war. The aftermath of the war leaves a death rate of 600 Million people." },
                    ...
                    new TrekEvent { Date = 2079, Description = "Earth is finally recovering from the nuclear war." },

                    new TrekEvent { Date = 2119, Description = "Zefram Cochrane sets off from his home on Alpha Centauri on an adventure. The world, never hearing back from him again presumes that he is dead." },

                    new TrekEvent { Date = 2156, Description = "Star of the Earth and Ramulan War" },

                    new TrekEvent { Date = 2160, Description = "Earth-Ramulan War comes to a close with the Battle of Cheron, which results in Earth inflicting a humiliating defeat to the Romulans. The Neutral Zone is then later established." },

                    new TrekEvent { Date = 2161, Description = "The United Federation of Planets is founded by Earth, Tellar, Vulcan and Andoria." },

                    new TrekEvent { Date = 2165, Description = "Sarek, Vulcan's future Ambassador and Spock's Father is born." },

                    new TrekEvent { Date = 2222, Description = "Montgomery Scott is born." },

                    new TrekEvent { Date = 2227, Description = "Leonard McCoy is born." },

                    new TrekEvent { Date = 2230, Description = "Spock and Hikaru Sulu are born." },

                    new TrekEvent { Date = 2233, Description = "James T. Kirk and Nyota Uhura is born." },

                    new TrekEvent { Date = 2245, Description = "Pavel Chekov is born. The USS Enterprise, a Constitution class vessel is launched under the command of Robert April, on a five-year mission of exploration." },

                    new TrekEvent { Date = 2250, Description = "The USS Enterprise is refitted and renamed NCC-1701. It is launched on a second five-year mission under the command of Captain Christopher Pike." },
                    ...
                    new TrekEvent { Date = 2270, Description = "The USS Enterprise returns home from it's 5 year journey. Captain Kirk is promoted to Admiral and the Enterprise undergoes maintenance and refitting." },
                    ...
                    new TrekEvent { Date = 2279, Description = "The USS Enterprise UCC-1701 returns from it's voyage and is retired from active duty and is repurposed as a training vessel." },
                    ...
                    new TrekEvent { Date = 2287, Description = "A group of separatists take Federation Ambassadors of Earth, Klingon and Ramulas hostage on Nimbus III. Captain Kirk and the crew of the Enterprise is asked to intercept and save the hostages." },
                    ...
                    new TrekEvent {Date = 2305, Description = "Jean-Luc Picard is born in LaBarre, France on Earth" }, 
                    ...
                    new TrekEvent{Date = 2324, Description = "Beverly Howard (Crusher) is born in Copernicus City, Luna" }, 
                    
                    new TrekEvent{Date = 2327, Description = "Jean-Luc Picard graduates from Starfleet Academy on Earth" }, 
                    
                    new TrekEvent {Date = 2333, Description = "Jean-Luc Picard becomes the Captain of the USS Stargazer." }, 
                    
                    new TrekEvent {Date = 2335, Description = "Geordi La Forge is born in Mogadishu, Somalia. William T. Riker is born in Valdez, Alaska" }, 
                    
                    new TrekEvent {Date = 2336, Description = "Deanna Troi is born on Betazed." }, 


                    new TrekEvent {Date=2337, Description = "Tasha yar is born in a failed Federation colony on Turkana IV" }, 
                    
                    new TrekEvent {Date = 2340, Description = "Worf, son of Mogh, is born on the Kilingon homeworld, Qo'noS" },
                    ...
                    new TrekEvent { Date = 2379, Description = "The events of Star Trek: Nemesis, Discovery of previously unknown Android named 'B-4', a less advanced android designed by Dr.Soong and brother to LT. Commander Data. Lt. Commander Data sacrifices his Life to save Picard and the crew of the Enterprise" },
                    ...
                    new TrekEvent { Date = 2372, Description = "Sovereign-class USS Enterprise (NCC-1701-E) is launched under the command of Captain Jean-Luc Picard." },
                    ...
                    new TrekEvent { Date = 2363, Description = "USS Enterprise (NCC-1701-D), the third Galaxy-class starship (following the Galaxy and Yamato) is launched from the Utopia Planitia shipyards in Mars orbit (under the command of Jean-Luc Picard), and becomes the Federation's new flagship." },

                    new TrekEvent { Date = 2364, Description = "The Stargazer is later recovered in 2364."},

                    new TrekEvent { Date = 2357, Description = "Worf is the first Klingon to enter Starfleet Academy."},
                    ...
                    new TrekEvent { Date = 2346, Description = "Worf's parents are killed by Romulans in the Khitomer massacre. Worf (age 6) is adopted by human parents."},
